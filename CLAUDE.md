...
`mcp-custos` is an MCP server exposing secure-coding and compliance reference data (ISO 27001, NIST 800-53, OWASP ASVS, NIST SSDF, ISO 27017, NIST cloud guidance) plus the pre-edit and pre-commit hooks that make consultation land in code. See `README.md` for the product picture.
